...
/* ──── DATA ──── */
const SERVICES=[
 {title:'Network Infrastructure & Design',icon:'<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="8" rx="2"/><rect x="2" y="14" width="20" height="8" rx="2"/><line x1="6" y1="6" x2="6.01" y2="6"/><line x1="6" y1="18" x2="6.01" y2="18"/></svg>',img:'assets/img/pdf-extracted/service-network.png',items:['ออกแบบและวางระบบเครือข่าย LAN/Fiber Optic','Server และ Network Security','Smart Classroom Solution','Digital Language Lab']},
 {title:'Software & Application Development',icon:'<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>',img:'https://v4i.rweb-images.com/www.edtech-info.com/images/editor/11_Vantage-04.jpg',items:['Custom Software','Mobile & Web Application','System Integration','Learning Management System (LMS)']},
 {title:'IT Maintenance Service',icon:'<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z"/></svg>',img:'https://v4i.rweb-images.com/www.edtech-info.com/images/editor/11_Vantage-05.jpg',items:['บริการดูแลรักษารายเดือน-รายปี','ตรวจเช็กระบบและกู้คืนข้อมูล','ดูแลอุปกรณ์และซอฟต์แวร์']},
 {title:'Hardware & Software Supply',icon:'<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>',img:'https://v4i.rweb-images.com/www.edtech-info.com/images/editor/11_Vantage-06.jpg',items:['อุปกรณ์คอมพิวเตอร์และซอฟต์แวร์ลิขสิทธิ์','Interactive Smart Display','สื่อมัลติมีเดียเพื่อการศึกษา']},
 {title:'ICT Training & Seminar',icon:'<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>',img:'assets/img/pdf-extracted/training-group.png',items:['อบรมการใช้งานระบบและซอฟต์แวร์','อบรม Smart Classroom / Language Lab','อบรมสื่อการเรียนรู้และ CEFR']},
 {title:'บริการพัฒนาแอปพลิเคชันและระบบอัตโนมัติด้วย AI',icon:'<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a4 4 0 014 4c0 1.95-1.4 3.57-3.25 3.93a1 1 0 00-.75.97V14"/><circle cx="12" cy="17" r="1"/></svg>',img:'https://v4i.rweb-images.com/www.edtech-info.com/images/editor/11_Vantage-04.jpg',items:['พัฒนา AI Application ให้เหมาะกับความต้องการขององค์กร','ออกแบบระบบอัตโนมัติด้วย AI เพื่อลดขั้นตอนการทำงาน','เชื่อมต่อ AI เข้ากับ Web / Mobile / Business Process'],isAI:true}
];
...
const PRODUCT_GROUPS=[
 {title:'หลักสูตรภาษาอังกฤษสำหรับเด็ก',en:"CHILDREN'S ENGLISH PROGRAMS",intro:'หลักสูตรภาษาอังกฤษสำหรับเด็กที่เน้นการเรียนรู้แบบผสมผสาน สนุก และพัฒนาทักษะภาษาอย่างเป็นขั้นตอน',products:[
  {name:'Phonics Hero',desc:'ติดกระดุมเม็ดแรกให้กับการเรียนภาษาอังกฤษด้วย Phonics Hero หลักสูตร Phonics สำหรับเด็ก เน้นการออกเสียงตัวอักษรและคำศัพท์เบื้องต้น ผ่านเกมและกิจกรรม interactive พร้อมบทเรียนมากกว่า 600 บทเรียน',level:'Phonics / เด็กเล็ก',img:'assets/img/phonics-hero-logo.png',source:EDTECH+'17553243/phonics-hero'},
 ...
 {title:'หลักสูตรภาษาอังกฤษเพื่อการสื่อสาร',en:'COMMUNICATIVE ENGLISH PROGRAMS',intro:'หลักสูตรเพื่อฝึกการสื่อสารภาษาอังกฤษในสถานการณ์จริง พร้อมแนวทางการเรียนรู้ที่สอดคล้องกับ CEFR',products:[
  {name:'Velawoods English',desc:'เรียนรู้และฝึกทักษะการสื่อสารภาษาอังกฤษผ่านสถานการณ์ในชีวิตประจำวัน โดยการจำลองตัวเองเป็นตัวละครในเมืองเสมือนจริง Velawoods ราคาเริ่มต้นที่ 12,000 บาท เหมาะสำหรับผู้เรียนทุกระดับตั้งแต่ A1-B1',level:'CEFR A1 – B1',img:'https://v4i.rweb-images.com/www.edtech-info.com/images/editor/MAIN-24.jpg',source:EDTECH+'17312037/velawoods-english'},
  {name:'Vantage Connected Learn Social',desc:'พัฒนาทักษะการสื่อสารภาษาอังกฤษตามกรอบมาตรฐาน CEFR ผ่าน Learn Social Platform รองรับทั้งผู้เรียน กลุ่มเรียน และผู้สอน มีระบบติดตามผลการเรียนรู้',level:'CEFR A1 – B1',img:IMG+'vantage-connected.png',source:EDTECH+'17604389/vantage-connected-learn-social'},
 ...
 {title:'สื่อมัลติมีเดียระดับปฐมวัย',en:'PRESCHOOL MULTIMEDIA',intro:'สื่อการเรียนรู้ที่ออกแบบให้เหมาะกับเด็กปฐมวัยและการใช้งานผ่านห้องเรียนหรือกระดานอัจฉริยะ',products:[
  {name:'Click2Plearn',desc:'สื่อการเรียนรู้ดิจิทัลสำหรับเด็กปฐมวัยที่สอดคล้องกับหลักสูตรการศึกษาปฐมวัย พ.ศ. 2560 ส่งเสริมพัฒนาการ 4 ด้าน ได้แก่ ร่างกาย อารมณ์ สังคม และสติปัญญา ผ่านเกมและกิจกรรมโต้ตอบ',level:'ปฐมวัย',img:'assets/img/click2plearn-screenshot.png',source:EDTECH+'17310719/click2plearn'},
 ...
 {title:'สื่อมัลติมีเดียระดับประถมศึกษา',en:'PRIMARY MULTIMEDIA',intro:'สื่อดิจิทัลเพื่อการเรียนการสอนระดับประถมศึกษา ครอบคลุมหลายกลุ่มสาระและใช้งานกับห้องเรียนสมัยใหม่',products:[
  {name:'Digital Library@School',desc:'คลังสื่อและบทเรียนดิจิทัลสำหรับการเรียนรู้ในโรงเรียน ครอบคลุมหลายกลุ่มสาระ ใช้งานผ่านห้องเรียนอัจฉริยะ Digital Library พร้อมระบบจัดการเนื้อหา',level:'ประถมศึกษา',img:'https://v4i.rweb-images.com/www.edtech-info.com/images/editor/DLS-2.jpg',source:EDTECH+'17345111/digital-libraryschool'},
...
const TRAINING=[
 {title:'อบรมเชิงปฏิบัติการสำหรับครูผู้สอน',icon:'<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z"/><path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z"/></svg>',img:'assets/img/pdf-extracted/training-picaro.png',items:['การใช้สื่อดิจิทัลเพื่อการเรียนการสอน','กิจกรรมเชิงปฏิบัติการสำหรับผู้สอน']},
 {title:'Picaro English Training',icon:'<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>',img:'assets/img/pdf-extracted/training-cefr.png',items:['แนวทางการเรียนรู้ภาษาอังกฤษ','กิจกรรม Inspire Motivate Enjoy']},
 {title:'English CEFR Boost Day',icon:'<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',img:'assets/img/pdf-extracted/training-group.png',items:['กิจกรรมพัฒนาทักษะภาษาอังกฤษ','แนวทางการประยุกต์ใช้ CEFR']}
];
